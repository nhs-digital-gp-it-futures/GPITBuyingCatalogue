...
(
    ...
    CONSTRAINT FK_CompetitionRecipientCommissionedBy_CompetitionRecipients FOREIGN KEY ([CompetitionId], [RecipientOdsCode]) REFERENCES [competitions].[CompetitionRecipients]([CompetitionId],[OdsCode]) ON DELETE CASCADE,
    ...
    CONSTRAINT FK_CompetitionRecipientCommissionedBy_OdsOrganisations_CommissionedBy FOREIGN KEY ([CommissionedByOdsCode]) REFERENCES [ods_organisations].[OdsOrganisations]([Id])
)
