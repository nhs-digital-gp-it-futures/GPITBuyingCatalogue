...
(
    ...
    CONSTRAINT FK_CompetitionSublocationRecipients_CompetitionRecipients FOREIGN KEY ([CompetitionId], [RecipientOdsCode]) REFERENCES [competitions].[CompetitionRecipients]([CompetitionId],[OdsCode]) ON DELETE CASCADE,
