...
(
    ...
    CONSTRAINT PK_ServiceQuantitiesSublocationRecipients PRIMARY KEY ([CompetitionId], [SolutionId], [ServiceId], [ParentSublocationOdsCode], [RecipientOdsCodeCode]),
    ...
    CONSTRAINT FK_ServiceQuantitiesSublocationRecipients_SublocationRecipient FOREIGN KEY ([CompetitionId], [ParentSublocationOdsCode], [RecipientOdsCodeOdsCode]) REFERENCES [competitions].[CompetitionSublocationRecipients] ([CompetitionId], [ParentSublocationOdsCode], [RecipientOdsCode])  ON DELETE CASCADE
)