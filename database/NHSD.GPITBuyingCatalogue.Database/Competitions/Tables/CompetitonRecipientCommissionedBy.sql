...
(
    ...
    CONSTRAINT FK_CompetitonRecipientCommissionedBy_CompetitionSublocationOwners FOREIGN KEY ([CompetitionId], [CommissionedByOdsCode]) REFERENCES [competitions].[CompetitionSublocationOwners]([CompetitionId],[SublocationOdsCode])
)
