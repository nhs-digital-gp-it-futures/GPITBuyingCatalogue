...
(
    SELECT r.OrderId, r.CatalogueItemId, r.OdsCode,
      ...
      FROM ordering.OrderItemRecipients AS r
           INNER JOIN dbo.CatalogueItem AS c ON c.CatalogueItemId = r.CatalogueItemId
                   AND c.CatalogueItemTypeId IN (1, 2)
           LEFT OUTER JOIN dbo.AdditionalService AS a ON a.CatalogueItemId = r.CatalogueItemId
