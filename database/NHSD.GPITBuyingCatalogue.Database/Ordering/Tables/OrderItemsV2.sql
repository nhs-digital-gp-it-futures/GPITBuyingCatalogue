...
(
    ...
    PriceId INT NULL,
    Price DECIMAL(18, 4) NULL CONSTRAINT OrderItemV2_PositivePrice CHECK (Price >= 0.00),
    ParentId INT NULL,
    ...
    [Quantity] INT NULL CONSTRAINT OrderItemV2_PositiveQuantity CHECK (Quantity > 0),
