...
BEGIN
    ...
    INSERT [catalogue].[ServiceLevelAgreements] ([SolutionId], [SlaType]) VALUES (N'10007-002', 1)
    ...
    INSERT [catalogue].[ServiceAvailabilityTimes] ([Id], [SolutionId], [Category], [TimeFrom], [TimeUntil], [ApplicableDays]) VALUES (21, N'10007-002', N'Core support hours', CAST(N'2021-11-12T06:30:00.0000000' AS DateTime2), CAST(N'2021-11-12T20:30:00.0000000' AS DateTime2), N'Monday – Sunday inclusive and including Bank Holidays.')
    INSERT [catalogue].[ServiceAvailabilityTimes] ([Id], [SolutionId], [Category], [TimeFrom], [TimeUntil], [ApplicableDays]) VALUES (22, N'10007-002', N'Non-core support hours', CAST(N'2021-11-12T20:30:00.0000000' AS DateTime2), CAST(N'2021-11-12T06:30:00.0000000' AS DateTime2), N'Monday – Sunday inclusive and including Bank Holidays.')
