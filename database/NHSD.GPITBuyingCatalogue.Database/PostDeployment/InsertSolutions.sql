...
BEGIN
    ...
    BEGIN
        ...
        VALUES (
            ...
            '[{"Link":"https://digital.nhs.uk/services/gp-systems-of-choice/pairing-integration","Name":"IM1","SubTypes":[{"Name":"Bulk","DetailsDictionary":{},"DetailsSystemDictionary":{"Provider":{"Audit+":"Audit+ utilises a bulk extraction of full clinical records (including confidential and deceased patients) from EMIS Web to provide General Practices with a crossplatform clinical decision support and management tool; supporting QOF performance management, improvement and NHS Health Checks.","Informatics Platform":"A Risk Stratification tool","Censure":"Storm is a sophisticated management information reporting interface that presents EMIS Web, allowing users to display their data in the most impactful and effective format; selecting from a range of arrangements and graphical forms."}}},{"Name":"Transactional","DetailsDictionary":{},"DetailsSystemDictionary":{"Provider":{"Audit+":"Audit+ utilises a bulk extraction of full clinical records (including confidential and deceased patients) from EMIS Web to provide General Practices with a crossplatform clinical decision support and management tool; supporting QOF performance management, improvement and NHS Health Checks.","Informatics Platform":"A Risk Stratification tool","Censure":"Storm is a sophisticated management information reporting interface that presents EMIS Web, allowing users to display their data in the most impactful and effective format; selecting from a range of arrangements and graphical forms."}}}]},{"Link":"https://digital.nhs.uk/services/gp-connect","Name":"GP Connect","SubTypes":[{"Name":"Access Record HTML","DetailsDictionary":{"Provider":"EMIS Web received Full Roll Out Approval from NHS Digital for GP Connect HTML View Provision on 20/06/19","Consumer":"EMIS Web is accredited to consume GP Connect HTML views"},"DetailsSystemDictionary":{}},{"Name":"Appointment Management","DetailsDictionary":{"Provider":"EMIS Web received Full Roll Out Approval from NHS Digital for GP Connect HTML View Provision on 20/06/19","Consumer":"EMIS Web is accredited to consume GP Connect HTML views"},"DetailsSystemDictionary":{}}]}]',
