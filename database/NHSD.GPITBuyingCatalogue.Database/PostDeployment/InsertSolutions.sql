...
BEGIN
    ...
    BEGIN
        ...
        INSERT INTO catalogue.SolutionIntegrations (CatalogueItemId, IntegrationTypeId, [Description], IsConsumer, IntegratesWith)
             VALUES (@solutionId, 1, 'Audit+ utilises a bulk extraction of full clinical records (including confidential and deceased patients) from EMIS Web to provide General Practices with a crossplatform clinical decision support and management tool; supporting QOF performance management, improvement and NHS Health Checks.', 0, 'Audit+'),
                    (@solutionId, 1, 'A Risk Stratification tool', 0, 'Informatics Platform'),
                    (@solutionId, 1, 'Storm is a sophisticated management information reporting interface that presents EMIS Web, allowing users to display their data in the most impactful and effective format; selecting from a range of arrangements and graphical forms.', 0, 'Censure'),
                    (@solutionId, 2, 'Audit+ utilises a bulk extraction of full clinical records (including confidential and deceased patients) from EMIS Web to provide General Practices with a crossplatform clinical decision support and management tool; supporting QOF performance management, improvement and NHS Health Checks.', 0, 'Audit+'),
                    (@solutionId, 2, 'A Risk Stratification tool', 0, 'Informatics Platform'),
                    (@solutionId, 2, 'Storm is a sophisticated management information reporting interface that presents EMIS Web, allowing users to display their data in the most impactful and effective format; selecting from a range of arrangements and graphical forms.', 0, 'Censure'),
                    (@solutionId, 4, 'EMIS Web received Full Roll Out Approval from NHS Digital for GP Connect Access Record HTML Provision on 20/06/19', 0, NULL),
                    (@solutionId, 4, 'EMIS Web is accredited to consume GP Connect Access Record HTMLs', 1, NULL),
                    (@solutionId, 5, 'EMIS Web received Full Roll Out Approval from NHS Digital for GP Connect Access Record HTML Provision on 20/06/19', 0, NULL),
                    (@solutionId, 5, 'EMIS Web is accredited to consume GP Connect Access Record HTMLs', 1, NULL);
    END;
