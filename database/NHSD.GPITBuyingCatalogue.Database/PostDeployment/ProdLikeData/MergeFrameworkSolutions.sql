...
BEGIN
    ...
    INSERT INTO #FrameworkSolutions (FrameworkId, SolutionId, IsFoundation, LastUpdated, LastUpdatedBy)
         VALUES (N'TIF001', N'10000-001', 1, CAST(N'2020-03-25T07:30:18.1133333' AS datetime2), @bobUser),
                ...
                (N'NHSDGP001', N'10011-003', 0, CAST(N'2020-06-18T14:20:53.8233333' AS datetime2), @bobUser),
                ...
                (N'NHSDGP001', N'10046-001', 0, CAST(N'2020-03-30T13:02:24.5200000' AS datetime2), @bobUser),
                (N'NHSDGP001', N'10046-003', 0, CAST(N'2020-03-30T13:04:21.6500000' AS datetime2), @bobUser),
                (N'NHSDGP001', N'10046-006', 0, CAST(N'2020-06-25T14:31:07.2366667' AS datetime2), @bobUser),
                (N'NHSDGP001', N'10047-001', 0, CAST(N'2020-04-01T10:43:15.8533333' AS datetime2), @bobUser),
                (N'NHSDGP001', N'10052-002', 1, CAST(N'2020-03-30T13:19:48.8766667' AS datetime2), @bobUser),
                (N'NHSDGP001', N'10059-001', 0, CAST(N'2020-03-30T13:16:49.4100000' AS datetime2), @bobUser),
                (N'NHSDGP001', N'10062-001', 0, CAST(N'2020-04-03T12:28:52.3800000' AS datetime2), @bobUser),
                (N'NHSDGP001', N'10063-002', 0, CAST(N'2020-06-25T14:30:56.3300000' AS datetime2), @bobUser),
                (N'NHSDGP001', N'10064-003', 0, CAST(N'2020-06-25T14:30:49.8600000' AS datetime2), @bobUser),
                (N'NHSDGP001', N'10072-003', 0, CAST(N'2020-06-25T14:30:33.5166667' AS datetime2), @bobUser),
                (N'NHSDGP001', N'10072-004', 0, CAST(N'2020-06-25T14:31:34.0466667' AS datetime2), @bobUser),
