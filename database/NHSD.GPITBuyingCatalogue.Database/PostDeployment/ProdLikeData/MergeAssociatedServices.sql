...
BEGIN
    ...
    INSERT INTO #AssociatedService (CatalogueItemId, [Description], OrderGuidance, LastUpdated, LastUpdatedBy) 
         VALUES 
                ...
                GETUTCDATE(), 
                @bobUser),
                (N'10072-S-005', N'Push Access - Implementation DESCRIPTION', N'', GETUTCDATE(), @bobUser),
                (N'10072-S-010', 
                ...
                GETUTCDATE(), 
                @bobUser),
                (N'10000-S-141', N'Online and Video Consult – Implementation DESCRIPTION', N'', GETUTCDATE(), @bobUser);
