...
BEGIN
    DECLARE @northLincsOrgId INT = (SELECT Id FROM organisations.Organisations WHERE PrimaryRoleId = 'RO98' AND OdsCode = '03K');
    DECLARE @hullOrgId INT = (SELECT Id FROM organisations.Organisations WHERE PrimaryRoleId = 'RO98' AND OdsCode = '03F');
