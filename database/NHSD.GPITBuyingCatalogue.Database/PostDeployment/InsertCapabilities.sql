...
(22, 'Caseload Management', 'Supports the allocation of appropriate Health and Care Professionals to Patients/Service Users in need of support, ensuring balanced workloads and the efficient use of staff and other resources.', @gpitFuturesBaseUrl + '1391133457/Caseload+Management', 0, 7),
(23, 'Cross-organisation Appointment Booking', 'Enables appointments to be made available and booked across Organisational boundaries, creating flexibility for Health and Care Professionals and Patients/Service Users.', @gpitFuturesBaseUrl + '1391135407/Cross-organisation+Appointment+Booking', 0, 1),
...
(32, 'Personal Health Budget', 'Enables a Patient/Service User to set up and manage a Personal Health Budget giving them more choice and control over the management of their identified healthcare and well-being needs.', @gpitFuturesBaseUrl + '1391133426/Personal+Health+Budget', 0, 3),
(33, 'Personal Health Record', 'Enables a Patient/Service User to manage and maintain their own Electronic Health Record and to share that information with relevant Health and Care Professionals.', @gpitFuturesBaseUrl + '1391135480/Personal+Health+Record', 0, 3),
...
(36, 'Shared Care Plans', 'Enables the maintenance of a single, shared care plan across multiple Organisations to ensure more co-ordinated working and more efficient management of activities relating to the Patient/Service User''s health and care.', @gpitFuturesBaseUrl + '1391134486/Shared+Care+Plans', 0, 9),
(37, 'Social Prescribing', 'Supports the referral of Patients/Service Users to non-clinical services to help address their health and well-being needs.', @gpitFuturesBaseUrl + '1391135572/Social+Prescribing', 0, 4),
...
(44, 'Video Consultation', 'The Video Consultation Capability allows Health or Care Professionals to conduct secure live remote video consultations with individual or groups of Patients/Service Users/Proxies ensuring they can receive support relating to healthcare concerns when a Video Consultation is most appropriate.', 'https://gpitbjss.atlassian.net/wiki/spaces/DFOCVCL/pages/5132484947/Video+Consultation', '1.0.0', '2021-03-11', 5, 'DFOCVC001');
