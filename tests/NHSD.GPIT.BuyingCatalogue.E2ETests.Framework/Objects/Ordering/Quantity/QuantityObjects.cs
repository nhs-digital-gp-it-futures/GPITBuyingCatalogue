...
namespace NHSD.GPIT.BuyingCatalogue.E2ETests.Framework.Objects.Ordering.Quantity
{
    public static class QuantityObjects
    {
        ...
        public static By DetailsQuantity => By.CssSelector("details.nhsuk-details[id^='SubLocations_']");
        public static By InputQuantityPracticeListSize => ByExtensions.DataTestId("input_quantity");

        public static By InputQuantityInput(int subLocations, int serviceRecipients) => By.Id($"SubLocations_{subLocations}__ServiceRecipients_{serviceRecipients}__InputQuantity");
