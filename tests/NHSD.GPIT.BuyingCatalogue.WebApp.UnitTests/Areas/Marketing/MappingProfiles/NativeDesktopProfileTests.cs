...
{
    public static class NativeDesktopProfileTests
    {
        private static readonly IMapper Mapper;

        static NativeDesktopProfileTests()
        {
        ...
        [Theory]
        [CommonAutoData]
        public static void Map_CatalogueItemToAdditionalInformationModel_ResultAsExpected(CatalogueItem catalogueItem)
        {
        ...
        [Theory]
        [CommonAutoData]
        public static void Map_CatalogueItemToConnectivityModel_ResultAsExpected(CatalogueItem catalogueItem)
        {
            var clientApplication =
                JsonConvert.DeserializeObject<ClientApplication>(catalogueItem.Solution.ClientApplication);
            ...
            actual.BackLinkText.Should().Be("Return to all sections");
            actual.ClientApplication.Should().BeEquivalentTo(clientApplication);
            actual.ConnectionSpeeds.Should()
                .BeEquivalentTo(
        ...
        [Theory]
        [CommonAutoData]
        public static void Map_CatalogueItemToHardwareRequirementsModel_ResultAsExpected(CatalogueItem catalogueItem)
        {
            var clientApplication =
                JsonConvert.DeserializeObject<ClientApplication>(catalogueItem.Solution.ClientApplication);
        ...
        [Theory]
        [CommonAutoData]
        public static void Map_CatalogueItemToMemoryAndStorageModel_ResultAsExpected(CatalogueItem catalogueItem)
        {
            var clientApplication =
                JsonConvert.DeserializeObject<ClientApplication>(catalogueItem.Solution.ClientApplication);
            ...
            actual.ScreenResolutions.Should()
                .BeEquivalentTo(
                    new List<SelectListItem>
                    {
        ...
        [Theory]
        [CommonAutoData]
        public static void Map_CatalogueItemToThirdPartyModel_ResultAsExpected(CatalogueItem catalogueItem)
        {
            var clientApplication =
                JsonConvert.DeserializeObject<ClientApplication>(catalogueItem.Solution.ClientApplication);
