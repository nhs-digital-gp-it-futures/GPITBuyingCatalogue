...
namespace NHSD.GPIT.BuyingCatalogue.WebApp.UnitTests.Areas.Marketing.MappingProfiles
{
    public sealed class BrowserBasedProfileTests : IDisposable
    {
            ...
            PlugInsOrExtensionsModel model)
        {
            ...
            requiredResolver.Setup(x => x.Resolve(
                It.IsAny<object>(),
                It.IsAny<object>(),
                model.PlugInsRequired,
                It.IsAny<bool?>(),
            ...
            SupportedBrowsersModel model)
        {
            ...
            mobileResponsiveResolver.Setup(x => x.Resolve(
                It.IsAny<object>(),
                It.IsAny<object>(),
                model.MobileResponsive,
                It.IsAny<bool?>(),
                It.IsAny<ResolutionContext>()))
                .Returns(expected);
            var serviceProvider = new Mock<IServiceProvider>();
            ...
            mobileResponsiveResolver.Verify(x => x.Resolve(
                It.IsAny<object>(),
                It.IsAny<object>(),
                model.MobileResponsive,
                It.IsAny<bool?>(),
