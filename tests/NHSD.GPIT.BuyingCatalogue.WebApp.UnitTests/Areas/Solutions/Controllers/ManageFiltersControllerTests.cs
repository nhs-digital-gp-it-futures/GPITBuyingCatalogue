    ...
    public static class ManageFiltersControllerTests
    {
            ...
            ManageFiltersController controller)
        {
            ...
            actualResult.RouteValues.Should().BeEquivalentTo(new RouteValueDictionary
            {
                ...
                { "selectedClientApplicationTypeIds", model.SelectedClientApplicationTypeIds },
            });
        }
        ...
        [Theory]
        [CommonAutoData]
        public static void Get_DeleteFilter_ReturnsExpectedResult(
            int filterId,
            ManageFiltersController controller)
        {
            var result = controller.DeleteFilter(filterId);
