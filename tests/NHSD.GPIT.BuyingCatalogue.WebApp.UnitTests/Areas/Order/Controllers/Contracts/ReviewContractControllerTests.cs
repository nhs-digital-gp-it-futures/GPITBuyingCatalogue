...
using NHSD.GPIT.BuyingCatalogue.WebApp.Areas.Order.Models.Contracts.Review;
using Xunit;
...
namespace NHSD.GPIT.BuyingCatalogue.WebApp.UnitTests.Areas.Order.Controllers.Contracts
{
    public static class ReviewContractControllerTests
    {
        ...
        public static void ClassIsCorrectlyDecorated()
        {
            ...
            typeof(ReviewContractController).Should().BeDecoratedWith<AreaAttribute>(a => a.RouteValue == "Order");
        }
