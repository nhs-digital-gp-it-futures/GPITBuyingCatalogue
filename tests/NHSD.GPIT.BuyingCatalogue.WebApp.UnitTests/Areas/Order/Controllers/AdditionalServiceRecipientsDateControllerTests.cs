...
namespace NHSD.GPIT.BuyingCatalogue.WebApp.UnitTests.Areas.Order.Controllers
{
    public static class AdditionalServiceRecipientsDateControllerTests
    {
            ...
            AdditionalServiceRecipientsDateController controller)
        {
            ...
            var actualResult = await controller.SelectAdditionalServiceRecipientsDate(odsCode, callOffId);
            ...
            AdditionalServiceRecipientsDateController controller)
        {
            ...
            await controller.SelectAdditionalServiceRecipientsDate(odsCode, callOffId, model);
