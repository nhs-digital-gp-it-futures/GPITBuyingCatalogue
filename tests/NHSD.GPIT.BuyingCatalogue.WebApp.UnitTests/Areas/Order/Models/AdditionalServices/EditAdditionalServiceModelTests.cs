...
namespace NHSD.GPIT.BuyingCatalogue.WebApp.UnitTests.Areas.Order.Models.AdditionalServices
{
    public static class EditAdditionalServiceModelTests
    {
        ...
        [Theory]
        [CommonInlineAutoData(ProvisioningType.Declarative, "/order/organisation/{0}/order/{1}/additional-services/select/additional-service/price/flat/declarative")]
        [CommonInlineAutoData(ProvisioningType.OnDemand, "/order/organisation/{0}/order/{1}/additional-services/select/additional-service/price/flat/ondemand")]
        [CommonInlineAutoData(ProvisioningType.Patient, "/order/organisation/{0}/order/{1}/additional-services/select/additional-service/price/recipients/date")]
