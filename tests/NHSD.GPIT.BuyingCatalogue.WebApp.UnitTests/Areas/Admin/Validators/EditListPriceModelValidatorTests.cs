...
namespace NHSD.GPIT.BuyingCatalogue.WebApp.UnitTests.Areas.Admin.Validators
{
    public static class EditListPriceModelValidatorTests
    {
        ...
        [Theory]
        [CommonAutoData]
        public static async Task Validate_Solution_ProvisioningTypeDeclarativeWithNoTimeUnit_SetsModelErrorForProvisioningType(
            CatalogueItem item,
            EditListPriceModelValidator validator)
        {
            var model = new EditListPriceModel(item)
        ...
        [Theory]
        [CommonAutoData]
        public static async Task Validate_AdditionalService_ProvisioningTypeDeclarativeWithNoTimeUnit_SetsModelErrorForProvisioningType(
            CatalogueItem item,
            EditListPriceModelValidator validator)
        {
            var model = new EditListPriceModel(item)
            ...
            result
                .ShouldNotHaveValidationErrorFor(m => m.DeclarativeTimeUnit);
        }
