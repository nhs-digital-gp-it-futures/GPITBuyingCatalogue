...
namespace NHSD.GPIT.BuyingCatalogue.WebApp.UnitTests.Areas.Admin.Validators
{
    public static class EditSupplierDetailsModelValidatorTests
    {
            ...
            EditSupplierDetailsModelValidator validator)
        {
            ...
            result.ShouldNotHaveValidationErrorFor(EditSupplierDetailsModelValidator.AvailableSupplierContactsName);
        }
            ...
            EditSupplierDetailsModelValidator validator)
        {
            ...
            result.ShouldHaveValidationErrorFor(EditSupplierDetailsModelValidator.AvailableSupplierContactsName)
