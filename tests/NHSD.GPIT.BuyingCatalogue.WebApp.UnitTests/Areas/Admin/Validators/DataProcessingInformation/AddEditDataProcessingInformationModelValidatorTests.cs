...
public static class AddEditDataProcessingInformationModelValidatorTests
{
        ...
        AddEditDataProcessingInformationModelValidator validator)
    {
        ...
        result.ShouldHaveValidationErrorFor(x => x.Subject)
            .WithErrorMessage(AddEditDataProcessingInformationModelValidator.SubjectMatterError);
    }
        ...
        AddEditDataProcessingInformationModelValidator validator)
    {
        ...
        result.ShouldHaveValidationErrorFor(x => x.Duration)
            .WithErrorMessage(AddEditDataProcessingInformationModelValidator.DurationError);
    }
        ...
        AddEditDataProcessingInformationModelValidator validator)
    {
        ...
        result.ShouldHaveValidationErrorFor(x => x.ProcessingNature)
            .WithErrorMessage(AddEditDataProcessingInformationModelValidator.ProcessingNatureError);
    }
        ...
        AddEditDataProcessingInformationModelValidator validator)
    {
        ...
        result.ShouldHaveValidationErrorFor(x => x.PersonalDataTypes)
            .WithErrorMessage(AddEditDataProcessingInformationModelValidator.PersonalDataTypesError);
    }
        ...
        AddEditDataProcessingInformationModelValidator validator)
    {
        ...
        result.ShouldHaveValidationErrorFor(x => x.DataSubjectCategories)
            .WithErrorMessage(AddEditDataProcessingInformationModelValidator.DataSubjectCategoriesError);
    }
        ...
        AddEditDataProcessingInformationModelValidator validator)
    {
        ...
        result.ShouldHaveValidationErrorFor(x => x.ProcessingLocation)
            .WithErrorMessage(AddEditDataProcessingInformationModelValidator.ProcessingLocationError);
    }
