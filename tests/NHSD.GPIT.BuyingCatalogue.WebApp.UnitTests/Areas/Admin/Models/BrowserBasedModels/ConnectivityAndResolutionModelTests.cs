...
namespace NHSD.GPIT.BuyingCatalogue.WebApp.UnitTests.Areas.Admin.Models.BrowserBasedModels
{
    public static class ConnectivityAndResolutionModelTests
    {
            ...
            Solution solution)
        {
            ...
            actual.SelectedConnectionSpeed.Should().Be(solution.GetApplicationTypes().MinimumConnectionSpeed);
            actual.SelectedScreenResolution.Should().Be(solution.GetApplicationTypes().MinimumDesktopResolution);
