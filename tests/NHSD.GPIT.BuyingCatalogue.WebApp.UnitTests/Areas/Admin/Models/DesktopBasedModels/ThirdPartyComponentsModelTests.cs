...
namespace NHSD.GPIT.BuyingCatalogue.WebApp.UnitTests.Areas.Admin.Models.DesktopBasedModels
{
    public static class ThirdPartyComponentsModelTests
    {
            ...
            Solution solution)
        {
            ...
            actual.ThirdPartyComponents.Should().Be(solution.ClientApplication.NativeDesktopThirdParty.ThirdPartyComponents);
            actual.DeviceCapabilities.Should().Be(solution.ClientApplication.NativeDesktopThirdParty.DeviceCapabilities);
        }
