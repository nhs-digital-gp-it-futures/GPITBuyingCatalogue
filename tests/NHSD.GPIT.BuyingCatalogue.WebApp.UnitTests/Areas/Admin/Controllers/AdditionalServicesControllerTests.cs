...
namespace NHSD.GPIT.BuyingCatalogue.WebApp.UnitTests.Areas.Admin.Controllers
{
    public static class AdditionalServicesControllerTests
    {
        ...
        {
            typeof(AdditionalServicesController).Should().BeDecoratedWith<AuthorizeAttribute>(a => a.Policy == "ManageCatalogueSolutions");
            typeof(AdditionalServicesController).Should().BeDecoratedWith<AreaAttribute>(a => a.RouteValue == "Admin");
        }
            ...
            AdditionalServicesController controller)
        {
            ...
            additionalServicesService.GetAdditionalService(solution.CatalogueItemId, additionalServiceId).Returns(default(CatalogueItem));
