...
namespace NHSD.GPIT.BuyingCatalogue.WebApp.UnitTests.Areas.Admin.Controllers
{
    public static class AdditionalServiceListPriceControllerTests
    {
            ...
            AdditionalServiceListPriceController controller)
        {
            ...
            await additionalServicesService.Received().GetAdditionalService(solution.CatalogueItemId, additionalService.CatalogueItemId);
            ...
            AdditionalServiceListPriceController controller)
        {
            ...
            await service.Received(1).UpdateTierPrice(additionalServiceId, cataloguePriceId, tierId, model.Price!.Value);
            ...
            AdditionalServiceListPriceController controller)
        {
            ...
            await listPriceService.Received(1).DeleteListPrice(additionalService.CatalogueItemId, price.CataloguePriceId);
            ...
            AdditionalServiceListPriceController controller)
        {
            ...
            await listPriceService.Received(1).DeletePriceTier(additionalService.CatalogueItemId, price.CataloguePriceId, tier.Id);
            ...
            AdditionalServiceListPriceController controller)
        {
            ...
            await listPriceService.Received(0).DeletePriceTier(additionalService.CatalogueItemId, price.CataloguePriceId, tier.Id);
