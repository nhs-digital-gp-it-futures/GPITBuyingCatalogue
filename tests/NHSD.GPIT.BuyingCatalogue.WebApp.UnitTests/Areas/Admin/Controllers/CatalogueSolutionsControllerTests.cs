...
public static class CatalogueSolutionsControllerTests
{
    ...
    {
        typeof(CatalogueSolutionsController).Should().BeDecoratedWith<AuthorizeAttribute>(a => a.Policy == "ManageCatalogueSolutions");
        typeof(CatalogueSolutionsController).Should().BeDecoratedWith<AreaAttribute>(a => a.RouteValue == "Admin");
    }
        ...
        CatalogueSolutionsController controller)
    {
        ...
        await mockSolutionService
            .Received()
            .SaveSolutionDetails(id, model.SolutionName, model.SupplierId ?? default, model.IsPilotSolution, model.SelectedCategory, model.Frameworks);
    }
    ...
    public static async Task Post_EditCapabilities_InvalidModel_ReturnsViewWithModel(
        ...
        CatalogueSolutionsController controller)
    {
        capabilitiesService.GetCapabilitiesByCategory().Returns([.. capabilityCategories]);
        var model = new EditCapabilitiesModel(catalogueItem, capabilityCategories)
        {
