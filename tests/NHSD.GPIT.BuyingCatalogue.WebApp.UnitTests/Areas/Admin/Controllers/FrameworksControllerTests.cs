...
public static class FrameworksControllerTests
{
        ...
        FrameworksController controller)
    {
        ...
        service.Verify(x => x.AddFramework(model.Name, It.IsAny<IEnumerable<FundingType>>(), It.IsAny<bool>()), Times.Once());
        ...
        FrameworksController controller)
    {
        ...
        service.Verify(x => x.UpdateFramework(frameworkId, model.Name, It.IsAny<IEnumerable<FundingType>>(), It.IsAny<bool>()), Times.Once());
