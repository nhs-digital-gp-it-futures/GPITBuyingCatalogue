...
public static class FrameworksControllerTests
{
    ...
    {
        typeof(FrameworksController).Should().BeDecoratedWith<AuthorizeAttribute>(a => a.Policy == "ManageContractingVehicles");
        typeof(FrameworksController).Should().BeDecoratedWith<AreaAttribute>(a => a.RouteValue == "Admin");
    }
