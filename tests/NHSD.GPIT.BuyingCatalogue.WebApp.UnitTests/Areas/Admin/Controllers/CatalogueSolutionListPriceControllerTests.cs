...
namespace NHSD.GPIT.BuyingCatalogue.WebApp.UnitTests.Areas.Admin.Controllers
{
    public static class CatalogueSolutionListPriceControllerTests
    {
            ...
            CatalogueSolutionListPriceController controller)
        {
            ...
            await listPriceService.Received().GetCatalogueItemWithListPrices(solution.CatalogueItemId);
            ...
            CatalogueSolutionListPriceController controller)
        {
            ...
            await service.Received(1).UpdateTierPrice(solutionId, cataloguePriceId, tierId, model.Price!.Value);
            ...
            CatalogueSolutionListPriceController controller)
        {
            ...
            await listPriceService.Received(1).DeleteListPrice(solution.CatalogueItemId, price.CataloguePriceId);
            ...
            CatalogueSolutionListPriceController controller)
        {
            ...
            await listPriceService.Received(1).DeletePriceTier(solution.CatalogueItemId, price.CataloguePriceId, tier.Id);
            ...
            CatalogueSolutionListPriceController controller)
        {
            ...
            await listPriceService.Received(0).DeletePriceTier(solution.CatalogueItemId, price.CataloguePriceId, tier.Id);
