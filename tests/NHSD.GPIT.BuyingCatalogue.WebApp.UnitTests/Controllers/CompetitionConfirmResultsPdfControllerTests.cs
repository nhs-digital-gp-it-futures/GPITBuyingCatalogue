...
public static class CompetitionConfirmResultsPdfControllerTests
{
    [Fact]
    public static void Constructors_VerifyGuardClauses()
    {
        ...
        var constructors = typeof(CompetitionConfirmResultsPdfController).GetConstructors();
    ...
    public static async Task Index_NullCompetition_ReturnsNotFoundResult(
        ...
        CompetitionConfirmResultsPdfController controller)
    {
