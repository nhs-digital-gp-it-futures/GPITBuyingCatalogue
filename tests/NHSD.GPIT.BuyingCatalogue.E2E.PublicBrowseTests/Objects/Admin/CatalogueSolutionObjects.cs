...
namespace NHSD.GPIT.BuyingCatalogue.E2ETests.Objects.Admin
{
    internal static class CatalogueSolutionObjects
    {
        ...
        internal static By SearchBar => By.Id("solutions-search");
        ...
        internal static By SearchListBox => By.Id("solutions-search__listbox");

        internal static By SearchResultsErrorMessage => By.ClassName("suggestion-search__option--no-results");

        internal static By SearchResult(uint index) => By.Id($"solutions-search__option--{index}");
