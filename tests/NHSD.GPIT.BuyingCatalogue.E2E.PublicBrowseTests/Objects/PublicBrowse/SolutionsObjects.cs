...
namespace NHSD.GPIT.BuyingCatalogue.E2ETests.Objects.PublicBrowse
{
    internal static class SolutionsObjects
    {
        ...
        internal static By SearchBar => By.Id("marketing-autocomplete");

        internal static By SearchListBox => By.Id("marketing-autocomplete__listbox");
        ...
        internal static By SearchResult(uint index) => By.Id($"marketing-autocomplete__option--{index}");
