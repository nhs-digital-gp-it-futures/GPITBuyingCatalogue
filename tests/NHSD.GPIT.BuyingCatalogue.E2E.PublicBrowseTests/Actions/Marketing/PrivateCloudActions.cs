...
{
    internal sealed class PrivateCloudActions : ActionBase
    {
        public PrivateCloudActions(IWebDriver driver) : base(driver)
        {
        }
        ...
        internal string EnterSummary(int charCount)
        {
            ...
            Driver.FindElement(HostingTypesObjects.PrivateCloud_Summary).SendKeys(summary);
        ...
        internal string EnterLink(int charCount)
        {
            ...
            Driver.FindElement(HostingTypesObjects.PrivateCloud_Link).SendKeys(link);
        ...
        internal string EnterHostingModel(int charCount)
        {
            ...
            Driver.FindElement(HostingTypesObjects.PrivateCloud_HostingModel).SendKeys(hostingModel);
