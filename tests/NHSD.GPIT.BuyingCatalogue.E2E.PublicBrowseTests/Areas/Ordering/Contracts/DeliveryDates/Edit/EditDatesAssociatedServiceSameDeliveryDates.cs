...
{
    public class EditDatesAssociatedServiceSameDeliveryDates : EditDates
    {
        private const int OrderId = 90020;
        ...
        public EditDatesAssociatedServiceSameDeliveryDates(LocalWebApplicationFactory factory)
