...
{
    public class EditDatesCatalogueSolutionSameDeliveryDates : EditDates
    {
        ...
        public EditDatesCatalogueSolutionSameDeliveryDates(LocalWebApplicationFactory factory)
