...
using NHSD.GPIT.BuyingCatalogue.WebApp.Areas.Order.Validators.ServiceRecipients;
using Xunit;
...
namespace NHSD.GPIT.BuyingCatalogue.E2ETests.Areas.Ordering.CatalogueSolutions
{
    public class SelectCatalogueSolutionRecipients : BuyerTestBase, IClassFixture<LocalWebApplicationFactory>, IDisposable
    {
        ...
        {
            CommonActions.PageTitle().Should().BeEquivalentTo("Service Recipients - DFOCVC Solution Full".FormatForComparison());
