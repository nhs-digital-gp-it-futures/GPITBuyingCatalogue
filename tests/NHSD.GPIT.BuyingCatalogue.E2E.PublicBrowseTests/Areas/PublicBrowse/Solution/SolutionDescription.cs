...
namespace NHSD.GPIT.BuyingCatalogue.E2ETests.Areas.PublicBrowse.Solution
{
    public sealed class SolutionDescription : AnonymousTestBase, IClassFixture<LocalWebApplicationFactory>, IDisposable
    {
        ...
        public void Description_Link_DisplaysEmbeddedLink()
        {
            ...
            var originalDescription = catalogueItem.Solution.FullDescription;

            catalogueItem.Solution.FullDescription = "https://www.fake.com";
            context.SaveChanges();
            ...
            catalogueItem.Solution.FullDescription = originalDescription;
            context.SaveChanges();
        }
