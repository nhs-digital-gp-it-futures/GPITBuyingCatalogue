...
namespace NHSD.GPIT.BuyingCatalogue.E2ETests.Areas.Admin.ListPrices.AssociatedService
{
    public sealed class ManageListPrices : ManageListPricesBase
    {
        ...
        protected override Type BacklinkController => typeof(AssociatedServicesController);

        protected override string BacklinkAction => nameof(AssociatedServicesController.EditAssociatedService);
    }
}
