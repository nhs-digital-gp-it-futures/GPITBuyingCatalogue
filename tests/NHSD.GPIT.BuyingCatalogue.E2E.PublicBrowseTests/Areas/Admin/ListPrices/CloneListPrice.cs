...
namespace NHSD.GPIT.BuyingCatalogue.E2ETests.Areas.Admin.ListPrices
{
    public sealed class CloneListPrice : AuthorityTestBase, IClassFixture<LocalWebApplicationFactory>, IDisposable
    {
        ...
        public CloneListPrice(LocalWebApplicationFactory factory)
            : base(factory, typeof(ListPriceController), nameof(ListPriceController.AddListPrice), Parameters, QueryParameters)
        {
        }
        ...
        public void CloneListPrice_ClickGoBackLink_ExpectedResult()
        {
            ...
            CommonActions.PageLoadedCorrectGetIndex(
                ...
                nameof(ListPriceController.ManageListPrices)).Should().BeTrue();
        }
        ...
        public void CloneListPrice_Submit_CreatesNewListPrice()
        {
            ...
            CommonActions.PageLoadedCorrectGetIndex(
                typeof(ListPriceController),
                nameof(ListPriceController.PublishListPrice)).Should().BeTrue();
        ...
        {
            return GetCataloguePrices().Single(x => x.CataloguePriceId == ListPriceId);
        }
