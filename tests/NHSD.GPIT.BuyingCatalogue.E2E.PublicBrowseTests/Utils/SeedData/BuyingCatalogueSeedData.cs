    ...
    internal static class BuyingCatalogueSeedData
    {
        ...
        private static void AddDefaultData(EndToEndDbContext context)
        {
            ...
            List<FrameworkCapability> frameworkCapabilities = new()
            {
                ...
                new FrameworkCapability { CapabilityId = 5, FrameworkId = "NHSDGP001" },
                ...
                new FrameworkCapability { CapabilityId = 11, FrameworkId = "NHSDGP001" },
                new FrameworkCapability { CapabilityId = 12, FrameworkId = "NHSDGP001" },
                new FrameworkCapability { CapabilityId = 13, FrameworkId = "NHSDGP001" },
                new FrameworkCapability { CapabilityId = 14, FrameworkId = "NHSDGP001" },
                new FrameworkCapability { CapabilityId = 15, FrameworkId = "NHSDGP001" },
