...
namespace NHSD.GPIT.BuyingCatalogue.E2ETests.Utils.SeedData
{
    internal static class BuyingCatalogueSeedData
    {
        ...
        private static void AddCatalogueItems(EndToEndDbContext context)
        {
            ...
            var theCatalogueItem = context.CatalogueItems.Single(c => c.CatalogueItemId == new CatalogueItemId(99999, "001A999"));
            var theCapability = context.Capabilities.Single(c => c.Id == new Guid("4F09E77B-E3A3-4A25-8EC1-815921F83628"));
            var theStatus = context.CatalogueItemCapabilityStatus.Single(s => s.Id == 1);
            ...
            List<CatalogueItemCapability> additionalServiceCapabilities = new()
            {
                new CatalogueItemCapability
                {
                    ...
                    CapabilityId = Guid.Parse("4F09E77B-E3A3-4A25-8EC1-815921F83628"),
        ...
        private static void AddDefaultData(EndToEndDbContext context)
        {
            ...
            List<Capability> capabilities = new()
            {
                ...
                new Capability { Id = new Guid("60C2F5B0-B950-44C8-A246-099335A1C816"), CapabilityRef = "C3", Name = "Prescription Ordering – Citizen", Description = "Enables Citizens to request medication online and manage nominated and preferred Pharmacies for Patients.", SourceUrl = $"{gpitFuturesBaseUrl}1391134214/Prescription+Ordering+-+Citizen", CategoryId = 1, Version = "1.0.1" },
                new Capability { Id = new Guid("64E5986D-1EBF-4DF0-8219-C150C082CA7B"), CapabilityRef = "C4", Name = "View Record – Citizen", Description = "Enables Citizens to view their Patient Record online.", SourceUrl = $"{gpitFuturesBaseUrl}1391134197/View+Record+-+Citize", CategoryId = 1, Version = "1.0.1" },
                new Capability { Id = new Guid("EFD93D25-447B-4CA3-9D78-108D42AFEAE0"), CapabilityRef = "C5", Name = "Appointments Management – GP", Description = "Supports the administration, scheduling, resourcing and reporting of appointments.", SourceUrl = $"{gpitFuturesBaseUrl}1391134029/Appointments+Management+-+GP", CategoryId = 1, Version = "1.0.1" },
                new Capability { Id = new Guid("A71F2BE1-6395-4DB7-828C-D4733B42B5B5"), CapabilityRef = "C6", Name = "Clinical Decision Support", Description = "Supports clinical decision-making to improve Patient safety at the point of care.", SourceUrl = $"{gpitFuturesBaseUrl}1391134150/Clinical+Decision+Support", CategoryId = 1, Version = "1.0.1" },
                new Capability { Id = new Guid("0A372F63-ADD4-4529-A6CD-4437C6EF115B"), CapabilityRef = "C7", Name = "Communication Management", Description = "Supports the delivery and management of communications to Citizens and Practice staff.", SourceUrl = $"{gpitFuturesBaseUrl}1391134087/Communication+Management", CategoryId = 1, Version = "1.0.1" },
                ...
                new Capability { Id = new Guid("B3F89711-6BD7-42D7-BE5B-BAE2F239EBDD"), CapabilityRef = "C14", Name = "Prescribing", Description = "Supports the effective and safe prescribing of medical products and appliances to Patients. Information to support prescribing will be available.", SourceUrl = $"{gpitFuturesBaseUrl}1391134158/Prescribing", CategoryId = 1, Version = "1.0.1" },
                ...
                new Capability { Id = new Guid("DD649CC4-A710-4472-98B3-663D9D12A8B7"), CapabilityRef = "C16", Name = "Reporting", Description = "Enables reporting and analysis of data from other Capabilities in the Practice Solution to support clinical care and Practice management.", SourceUrl = $"{gpitFuturesBaseUrl}1391133718/Reporting", CategoryId = 1, Version = "1.0.1" },
                new Capability { Id = new Guid("E5521A71-A28E-4BC9-BDDF-599F0A90719D"), CapabilityRef = "C17", Name = "Scanning", Description = "Support the con[Version] of paper documentation into digital format preserving the document quality and structure.", SourceUrl = $"{gpitFuturesBaseUrl}1391134270/Scanning", CategoryId = 1, Version = "1.0.1" },
                ...
                new Capability { Id = new Guid("9D325DEC-6E5B-44E4-876B-EACF6CD41B3E"), CapabilityRef = "C20", Name = "Workflow", Description = "Supports manual and automated management of work in the Practice. Also supports effective planning, tracking, monitoring and reporting.", SourceUrl = $"{gpitFuturesBaseUrl}1391134020/Workflow", CategoryId = 1, Version = "1.0.1" },
                ...
                new Capability { Id = new Guid("890AF628-5B84-4176-B3D1-A4ADC65710FE"), CapabilityRef = "C24", Name = "Cross-organisation Workflow Tools", Description = "Supports and automates clinical and business processes across Organisational boundaries to make processes and communication more efficient.", SourceUrl = $"{gpitFuturesBaseUrl}1391133492/Cross-organisation+Workflow+Tools", CategoryId = 1, Version = "1.0.1" },
                ...
                new Capability { Id = new Guid("12C6A61C-013C-475F-BB0C-2DA5D414C03B"), CapabilityRef = "C35", Name = "Risk Stratification", Description = "Supports Health and Care Professionals by providing trusted models to predict future Patient events, informing interventions to achieve better Patient outcomes.", SourceUrl = $"{gpitFuturesBaseUrl}1391133445/Risk+Stratificatio", CategoryId = 1, Version = "1.0.1" },
                ...
                new Capability { Id = new Guid("6E77147D-D2AF-46BD-A2F2-BB4F235DAF3A"), CapabilityRef = "C41", Name = "Productivity", Description = "Supports Patients/Service Users and Health and Care Professionals by delivering improved efficiency or experience related outcomes.", SourceUrl = $"{gpitFuturesBaseUrl}1391135618/Productivity", CategoryId = 1, Version = "1.0.1" },
                new Capability { Id = new Guid("D314DC27-BC65-4ABD-97C5-F9BE478D8A10"), CapabilityRef = "C42", Name = "Dispensing", Description = "Supports the timely and effective dispensing of medical products and appliances to Patients.", SourceUrl = $"{gpitFuturesBaseUrl}1391133465/Dispensing", CategoryId = 1, Version = "1.0.1" },
