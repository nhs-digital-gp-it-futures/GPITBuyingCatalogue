...
public class LoginTests : BaseTest
{
    ...
    [Fact]
    public async Task CatalogueSolutionUploadServiceRecipientsUsingSCV()
    {
        await orderPages.LoginAsync();
        ...
        //Service Recipients
        await Page.GetByRole(AriaRole.Link, new() { Name = "service recipients" }).ClickAsync();
        await Page.GetByLabel("Upload a CSV file").CheckAsync();
        await Page.GetByRole(AriaRole.Button, new() { Name = "Save and continue" }).ClickAsync();
        await Page.GetByRole(AriaRole.Heading, new() { Name = "Upload validated" }).IsVisibleAsync();
        await Page.GetByRole(AriaRole.Button, new() { Name = "Save and continue" }).ClickAsync();
        await Page.GetByRole(AriaRole.Heading, new() { Name = "Confirm sublocations" }).IsVisibleAsync();
        await Page.GetByRole(AriaRole.Button, new() { Name = "Save and continue" }).ClickAsync();
        await Page.GetByRole(AriaRole.Heading, new() { Name = "Confirm service recipients" }).IsVisibleAsync();
        ...
        await Page.GetByRole(AriaRole.Link, new() { Name = "Solutions and services" }).ClickAsync();
        await Page.GetByRole(AriaRole.Heading, new() { Name = "Catalogue solutions" }).IsVisibleAsync();
        await Page.GetByRole(AriaRole.Radio, new() { Name = "Anywhere Consult" }).CheckAsync();
        await Page.GetByRole(AriaRole.Button, new() { Name = "Save and continue" }).ClickAsync();
        await Page.GetByRole(AriaRole.Heading, new() { Name = "Catalogue solution and services" }).IsVisibleAsync();
        await Page.GetByRole(AriaRole.Link, new() { Name = "Start" }).ClickAsync();
        await Page.GetByRole(AriaRole.Heading, new() { Name = "Price of Catalogue solution" }).IsVisibleAsync();
        ...
        await Page.GetByRole(AriaRole.Link, new() { Name = "Save and continue" }).ClickAsync();
        await Page.GetByRole(AriaRole.Heading, new() { Name = "Are you sure you want to change your Catalogue solution?" }).IsVisibleAsync();
    ...
    public async Task EditOrderWithCatalogueSolutionAdditionalAndAssociatedService()
    {
        ...
        await Page.GetByRole(AriaRole.Heading, new() { Name = "Catalogue solution and services" }).IsVisibleAsync();
        await Page.GetByRole(AriaRole.Link, new() { Name = "Start" }).ClickAsync();
        await Page.GetByRole(AriaRole.Heading, new() { Name = "Price of Additional service" }).IsVisibleAsync();
        await Page.GetByRole(AriaRole.Button, new() { Name = "Save and continue" }).ClickAsync();
        await Page.GetByRole(AriaRole.Heading, new() { Name = "Catalogue solution and services" }).IsVisibleAsync();
        await Page.GetByRole(AriaRole.Link, new() { Name = "Start" }).ClickAsync();
        ...
        //Edit Additional
        await Page.GetByRole(AriaRole.Heading, new() { Name = "Edit solutions and services" }).IsVisibleAsync();
        await Page.GetByRole(AriaRole.Link, new() { Name = "Remove Automated Arrivals" }).ClickAsync();
        await Page.GetByRole(AriaRole.Heading, new() { Name = "Remove Additional service" }).IsVisibleAsync();
        await Page.GetByRole(AriaRole.Radio, new() { Name = "Yes, I confirm I want to" }).CheckAsync();
        await Page.GetByRole(AriaRole.Button, new() { Name = "Save and continue" }).ClickAsync();
        await Page.GetByRole(AriaRole.Link, new() { Name = "Add Additional services" }).ClickAsync();
        await Page.GetByRole(AriaRole.Checkbox, new() { Name = "Document Management" }).CheckAsync();
        await Page.GetByRole(AriaRole.Button, new() { Name = "Save and continue" }).ClickAsync();
        await Page.GetByRole(AriaRole.Heading, new() { Name = "Catalogue solution and services" }).IsVisibleAsync();
        await Page.GetByRole(AriaRole.Link, new() { Name = "Start" }).ClickAsync();
        await Page.GetByRole(AriaRole.Heading, new() { Name = "Price of Additional service" }).IsVisibleAsync();
        ...
        //Edit Associated service
        await Page.GetByRole(AriaRole.Heading, new() { Name = "Edit solutions and services" }).IsVisibleAsync();
        await Page.GetByRole(AriaRole.Link, new() { Name = "Remove Engineering" }).ClickAsync();
        await Page.GetByRole(AriaRole.Heading, new() { Name = "Remove Associated service" }).IsVisibleAsync();
        await Page.GetByRole(AriaRole.Radio, new() { Name = "Yes, I confirm I want to remove" }).CheckAsync();
        await Page.GetByRole(AriaRole.Button, new() { Name = "Save and continue" }).ClickAsync();
        await Page.GetByRole(AriaRole.Link, new() { Name = "Add Associated services" }).ClickAsync();
        await Page.GetByRole(AriaRole.Checkbox, new() { Name = "Installation" }).CheckAsync();
        await Page.GetByRole(AriaRole.Button, new() { Name = "Save and continue" }).ClickAsync();
        await Page.GetByRole(AriaRole.Heading, new() { Name = "Catalogue solution and services" }).IsVisibleAsync();
        await Page.GetByRole(AriaRole.Link, new() { Name = "Start" }).ClickAsync();
        ...
        //Funding source for additional service
        await Page.GetByRole(AriaRole.Row).Filter(new() { HasText = "Document Management" }).GetByRole(AriaRole.Link, new() { Name = "Start" }).ClickAsync();
        await Page.GetByRole(AriaRole.Heading, new() { Name = "Funding sources" }).IsVisibleAsync();
        await Page.GetByRole(AriaRole.Radio, new() { Name = "Local funding" }).CheckAsync();
        await Page.GetByRole(AriaRole.Button, new() { Name = "Save and continue" }).ClickAsync();
        await Page.GetByRole(AriaRole.Heading, new() { Name = "Funding sources" }).IsVisibleAsync();
        ...
        //Funding source for associated service
        await Page.GetByRole(AriaRole.Row).Filter(new() { HasText = "Installation" }).GetByRole(AriaRole.Link, new() { Name = "Start" }).ClickAsync();
        await Page.GetByRole(AriaRole.Heading, new() { Name = "Funding sources" }).IsVisibleAsync();
        await Page.GetByRole(AriaRole.Radio, new() { Name = "Local funding" }).CheckAsync();
        await Page.GetByRole(AriaRole.Button, new() { Name = "Save and continue" }).ClickAsync();
        await Page.GetByRole(AriaRole.Heading, new() { Name = "Funding sources" }).IsVisibleAsync();
