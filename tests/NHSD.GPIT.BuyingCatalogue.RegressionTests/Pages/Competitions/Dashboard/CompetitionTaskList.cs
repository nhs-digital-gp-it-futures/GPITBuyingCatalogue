...
namespace NHSD.GPIT.BuyingCatalogue.RegressionTests.Pages.Competitions.Dashboard
{
    public class CompetitionTaskList : PageBase
    {
        ...
        public void CompetitionServiceRecipientsTask()
        {
            ...
            CommonActions.HintText().Should().Be("Select the organisations that will receive the winning solution for this competition or upload them using a CSV file.".FormatForComparison());
        ...
        public void ViewResult()
        {
            ...
            CommonActions.HintText().Should().Be("Review the information you’ve added for this competition. If you’re happy, you can view your results and see your winning solution.".FormatForComparison());
        }
        ...
        public void NonPriceWeightings()
        {
            ...
            CommonActions.HintText().Should().Be("Give your chosen non-price elements weightings based on how important they are to you.".FormatForComparison());
        }
        ...
        public void ReviewCompetitionCriteria()
        {
            ...
            CommonActions.HintText().Should().Be("Review the weightings you’ve applied to your competition and the details of any non-price elements you’ve added.".FormatForComparison());
        }
