    ...
    public static class ManageFiltersServiceTests
    {
            ...
            ManageFiltersService service)
        {
            ...
            foreach (var x in result.FilterApplicationTypes)
            {
                ...
                cats.Should().Contain(x.ApplicationType);
            }
        }
            ...
            ManageFiltersService service)
        {
            ...
            filterIds.ApplicationTypeIds.Should().BeEquivalentTo(filter.FilterApplicationTypes.Select(fc => (int)fc.ApplicationType));
