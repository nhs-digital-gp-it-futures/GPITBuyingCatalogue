...
namespace NHSD.GPIT.BuyingCatalogue.Framework.UnitTests.Constants
{
    public static class SelectListsTests
    {
        ...
        {
            SelectLists.MemorySizes.Should().BeEquivalentTo(new List<SelectOption<string>>
            {
        ...
        {
            SelectLists.ConnectionSpeeds.Should().BeEquivalentTo(new List<SelectOption<string>>
            {
        ...
        {
            SelectLists.ScreenResolutions.Should().BeEquivalentTo(new List<SelectOption<string>>
            {
