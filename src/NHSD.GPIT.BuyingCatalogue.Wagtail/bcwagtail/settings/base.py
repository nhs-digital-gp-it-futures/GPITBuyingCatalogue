...
INSTALLED_APPS = [
    "bcwagtail.base",
    "bcwagtail.releasenotes",
    "bcwagtail.newfeatures",
    "bcwagtail.frameworks",
    "bcwagtail.search",
    "wagtail.embeds",
    "wagtail.sites",
    "wagtail.users",
...
WSGI_APPLICATION = "bcwagtail.wsgi.application"
...
if "DATABASE_URL" in os.environ:
    ...
    DATABASES = {
        "default": {
            ...
            "NAME": os.environ.get("SQL_DATABASE", os.path.join(BASE_DIR, "bcwagtaildb")),
