...
class Person(
    ...
    def preview_modes(self):
        return PreviewableMixin.DEFAULT_PREVIEW_MODES + [("releasenotes_post", _("releasenotes post"))]
    ...
    def get_preview_template(self, request, mode_name):
        ...
        if mode_name == "releasenotes_post":
            return releasenotesPage.template
    ...
    def get_preview_context(self, request, mode_name):
        ...
        page = releasenotesPage.objects.filter(releasenotes_person_relationship__person=self).first()
        if page:
            ...
            page = releasenotesPage.objects.first()
            page.authors = [self]
...
class HomePage(Page):
    ...
    # that we define on the individual Page models e.g. releasenotesIndexPage
...
class GalleryPage(Page):
    """
    This is a page to list frameworks from the selected Collection. We use a Q
...
class SiteSettings(BaseSiteSetting):
    title_suffix = models.CharField(
        ...
        max_length=255,
        help_text="The suffix for the title meta tag e.g. ' | The Buying Catalogue'",
        default="The Buying Catalogue",
    )
