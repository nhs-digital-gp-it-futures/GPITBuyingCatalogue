...
namespace NHSD.GPIT.BuyingCatalogue.Services.Solutions
{
    public sealed class ManageFiltersService : IManageFiltersService
    {
        ...
        public Task<Filter> GetFilter(int organisationId, int filterId)
        {
            return dbContext.Filters
                ...
                .AsSplitQuery()
                .FirstOrDefaultAsync(o => o.Id == filterId && o.OrganisationId == organisationId);
        }
        ...
        internal async Task AddFilterClientApplicationTypes(int filterId, List<ClientApplicationType> clientApplicationTypes)
        {
            ...
            var filter = await dbContext.Filters.Include(x => x.FilterClientApplicationTypes).FirstOrDefaultAsync(o => o.Id == filterId);
        ...
        internal async Task AddFilterHostingTypes(int filterId, List<HostingType> hostingTypes)
        {
            ...
            foreach (var type in hostingTypes.Where(type => filter.FilterHostingTypes.All(x => x.HostingType != type)))
            {
