...
namespace NHSD.GPIT.BuyingCatalogue.Services.Csv
{
    public sealed class FullOrderCsvModelMap : ClassMapWithNames<FullOrderCsvModel>
    {
            ...
            : base(new Dictionary<string, string>(Names).AsReadOnly())
        {
            ...
            Map(o => o.CommencementDate).Index(5).Name(GetName(nameof(FullOrderCsvModel.CommencementDate)));
            Map(o => o.ServiceRecipientId).Index(6).Name(GetName(nameof(FullOrderCsvModel.ServiceRecipientId)));
            Map(o => o.ServiceRecipientName).Index(7).Name(GetName(nameof(FullOrderCsvModel.ServiceRecipientName)));
            Map(o => o.ServiceRecipientItemId).Index(8).Name(GetName(nameof(FullOrderCsvModel.ServiceRecipientItemId)));
            Map(o => o.SupplierId).Index(9).Name(GetName(nameof(FullOrderCsvModel.SupplierId)));
            Map(o => o.SupplierName).Index(10).Name(GetName(nameof(FullOrderCsvModel.SupplierName)));
            Map(o => o.ProductId).Index(11).Name(GetName(nameof(FullOrderCsvModel.ProductId)));
            Map(o => o.ProductName).Index(12).Name(GetName(nameof(FullOrderCsvModel.ProductName)));
            Map(o => o.ProductType).Index(13).Name(GetName(nameof(FullOrderCsvModel.ProductType)));
            Map(o => o.QuantityOrdered).Index(14).Name(GetName(nameof(FullOrderCsvModel.QuantityOrdered)));
            Map(o => o.UnitOfOrder).Index(15).Name(GetName(nameof(FullOrderCsvModel.UnitOfOrder)));
            Map(o => o.UnitTime).Index(16).Name(GetName(nameof(FullOrderCsvModel.UnitTime)));
            Map(o => o.EstimationPeriod).Index(17).Name(GetName(nameof(FullOrderCsvModel.EstimationPeriod)));
            Map(o => o.Price).Index(18).Name(GetName(nameof(FullOrderCsvModel.Price)));
            Map(o => o.OrderType).Index(19).Name(GetName(nameof(FullOrderCsvModel.OrderType)));
            Map(o => o.FundingType).Index(20).Name(GetName(nameof(FullOrderCsvModel.FundingType)));
