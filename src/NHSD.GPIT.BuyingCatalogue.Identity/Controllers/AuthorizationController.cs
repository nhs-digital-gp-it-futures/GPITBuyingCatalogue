...
using NHSD.GPIT.BuyingCatalogue.Identity.Helpers;
using NHSD.GPIT.BuyingCatalogue.Identity.ViewModels.Authorization;
...
namespace NHSD.GPIT.BuyingCatalogue.Identity.Controllers;
...
public class AuthorizationController : Controller
{
    ...
    public async Task<IActionResult> Authorize()
    {
        ...
        switch (await _applicationManager.GetConsentTypeAsync(application))
        {
            ...
            case ConsentTypes.Explicit when authorizations.Count is not 0 && !request.HasPrompt(Prompts.Consent):
                ...
                await AddClaimsToIdentityAsync(identity, user);
    ...
    private async Task AddClaimsToIdentityAsync(ClaimsIdentity identity, AspNetUser user)
    {
        identity
