...
class CatalogueSolutionsFilter {
    ...
    generateQueryParam = () => {
        ...
        const query: string = "#" + filterContainer + " " + NhsukCheckboxesInput;
        let output: string = "";
        ...
        document.querySelectorAll(query).forEach(checkbox => {
            ...
            if (input.checked) {
                ...
                const value: string = checkbox.parentNode!.querySelector(InputTypeHidden)!.getAttribute("value");
    ...
    /// Normal
    // Normal just remove the Capability Id, so "C47E1" just becomes "E1", since they're tied to the capability
    // in the URL e.g "C47E1E2E3E4"
    /// DFOCVC
