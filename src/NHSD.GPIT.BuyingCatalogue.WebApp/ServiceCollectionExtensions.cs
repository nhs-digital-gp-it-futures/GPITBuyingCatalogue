...
namespace NHSD.GPIT.BuyingCatalogue.WebApp
{
    ...
    public static class ServiceCollectionExtensions
    {
        ...
        extension(IServiceCollection services)
        {
            ...
            public void ConfigureCookies(IConfiguration configuration)
            {
            ...
            public void ConfigureOds(IConfiguration configuration)
            {
            ...
            public void ConfigureDbContexts(IConfiguration configuration)
            {
            ...
            public void ConfigureSession(IConfiguration configuration)
            {
                var buyingCatalogueConnectionString = configuration.GetValue<string>(BuyingCatalogueDbConnectionEnvironmentVariable);
            ...
            public void ConfigureDisabledErrorMessage(IConfiguration configuration)
            {
            ...
            public void ConfigureDomainName(IConfiguration configuration)
            {
            ...
            public void ConfigurePdf(IConfiguration configuration)
            {
            ...
            public IServiceCollection ConfigurePriceTiersCap(IConfiguration configuration)
            {
            ...
            public IServiceCollection ConfigureAccountManagement(IConfiguration configuration)
            {
            ...
            public IServiceCollection ConfigureTermsOfUseSettings(IConfiguration configuration)
            {
            ...
            public IServiceCollection ConfigureConsentCookieSettings(IConfiguration configuration)
            {
                var cookieExpiration = configuration.GetSection("cookieExpiration").Get<CookieExpirationSettings>();
            ...
            public IServiceCollection ConfigureCallOffTermsSettings(IConfiguration configuration)
            {
            ...
            public IServiceCollection ConfigureCacheKeySettings(IConfiguration configuration)
            {
            ...
            public void ConfigureIdentity(IConfiguration configuration)
            {
            ...
            public void ConfigurePassword(IConfiguration configuration)
            {
                var passwordSettings = configuration.GetSection("password").Get<PasswordSettings>();
            ...
            public IServiceCollection ConfigureGovNotify(IConfiguration configuration)
            {
                var notifyApiKey = configuration.GetValue<string>("NOTIFY_API_KEY");
                if (!string.IsNullOrWhiteSpace(notifyApiKey))
                {
                    services.AddScoped<IAsyncNotificationClient, NotificationClient>(_ => new NotificationClient(notifyApiKey));
            ...
            public IServiceCollection ConfigureAnalyticsSettings(IConfiguration configuration)
            {
            ...
            public IServiceCollection ConfigureImportPracticeListMessageSettings(IConfiguration configuration)
            {
            ...
            public IServiceCollection ConfigureNominateOrganisationMessageSettings(IConfiguration configuration)
            {
            ...
            public IServiceCollection ConfigureOrderMessageSettings(IConfiguration configuration)
            {
            ...
            public IServiceCollection ConfigureProcurementHubMessageSettings(IConfiguration configuration)
            {
            ...
            public IServiceCollection ConfigureRequestAccountMessageSettings(IConfiguration configuration)
            {
            ...
            public void ConfigureContactUs(IConfiguration configuration)
            {
                var contactUsSettings = configuration.GetSection("contactUs").Get<ContactUsSettings>();
                services.AddSingleton(contactUsSettings);
            }

            public void ConfigureDataProtection(IConfiguration configuration)
            {
            ...
            public IServiceCollection AddFluentValidation()
            {
                return services.AddFluentValidation(
                    options =>
                    {
                        ...
                        options.ValidatorOptions.DefaultClassLevelCascadeMode = CascadeMode.Continue;
            ...
            public void ConfigureFormOptions()
            {
            ...
            public IServiceCollection ConfigureHsts(IConfiguration configuration)
            {
