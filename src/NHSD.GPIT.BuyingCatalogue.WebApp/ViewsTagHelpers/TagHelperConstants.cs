namespace NHSD.GPIT.BuyingCatalogue.WebApp.ViewsTagHelpers
{
    public sealed class TagHelperConstants
    {
        ...
        internal const string NhsTextArea = "nhsuk-textarea";
        internal const string NhsList = "nhsuk-list";
        internal const string NhsValidationSummary = "nhsuk-error-summary";
        internal const string NhsValidationSummaryTitle = "nhsuk-error-summary__title";
        internal const string NhsValidationSummaryList = "nhsuk-error-summary__list";
