    ...
    public sealed class OrderController : Controller
    {
        ...
        internal static string GetAdvice(OrderWrapper orderWrapper, bool latestOrder)
        {
            ...
            return order.OrderStatus switch
            {
                ...
                OrderStatus.Completed when latestOrder => "This order has already been completed, but you can amend or terminate the contract if needed. You can also change the order description, or change contact details for the call off party or supplier.",
