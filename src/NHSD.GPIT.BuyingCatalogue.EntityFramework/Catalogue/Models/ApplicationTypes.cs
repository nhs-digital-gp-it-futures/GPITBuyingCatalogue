    ...
    public sealed class ApplicationTypes
    {
        ...
        public IReadOnlyList<ApplicationType> ExistingClientApplicationTypes
        {
            get
            {
                ...
                foreach (ApplicationType clientApplicationType in Enum.GetValues(typeof(ApplicationType)))
                {
        ...
        public void EnsureClientApplicationTypePresent(ApplicationType clientApplicationType)
        {
        ...
        public bool HasClientApplicationType(ApplicationType clientApplicationType)
